...
@Since("3.2.0")
@DeveloperApi
case class ShufflePushMergeBlockId(
    shuffleId: Int,
    stageId: Int,
    stageAttemptNumber: Int,
    mapId: Long,
    reduceId: Int) extends BlockId {
  override def name: String = "shuffle_" + shuffleId + "_" + stageId + "_" +
    stageAttemptNumber + "_" + mapId + "_" + reduceId
}
...
case class ShuffleMergedDataBlockId(
  ...
  override def name: String = RemoteBlockPushResolver.MERGED_SHUFFLE_FILE_NAME_PREFIX + "_" +
    appId + "_" + shuffleId + "_" + stageId + "_" + stageAttemptNumber + "_" + reduceId + ".data"
}
...
case class ShuffleMergedIndexBlockId(
    ...
    reduceId: Int) extends BlockId {
  override def name: String = RemoteBlockPushResolver.MERGED_SHUFFLE_FILE_NAME_PREFIX + "_" +
    appId + "_" + shuffleId + "_" + stageId + "_" + stageAttemptNumber + "_" + reduceId + ".index"
}
...
case class ShuffleMergedMetaBlockId(
    ...
    reduceId: Int) extends BlockId {
  override def name: String = RemoteBlockPushResolver.MERGED_SHUFFLE_FILE_NAME_PREFIX + "_" +
    appId + "_" + shuffleId + "_" + stageId + "_" + stageAttemptNumber + "_" + reduceId + ".meta"
}
...
object BlockId {
  ...
  val SHUFFLE_PUSH = "shufflePush_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+)".r
  val SHUFFLE_MERGED_DATA =
    "shuffleMerged_([_A-Za-z0-9]*)_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+).data".r
  val SHUFFLE_MERGED_INDEX =
    "shuffleMerged_([_A-Za-z0-9]*)_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+).index".r
  val SHUFFLE_MERGED_META =
    "shuffleMerged_([_A-Za-z0-9]*)_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+).meta".r
  ...
  def apply(name: String): BlockId = name match {
    ...
    case SHUFFLE_PUSH(shuffleId, stageId, stageAttemptNumber, mapIndex, reduceId) =>
      ShufflePushBlockId(shuffleId.toInt, stageId.toInt, stageAttemptNumber.toInt, mapIndex.toInt,
        reduceId.toInt)
    case SHUFFLE_MERGED_DATA(appId, shuffleId, stageId, stageAttemptNumber, reduceId) =>
      ShuffleMergedDataBlockId(appId, shuffleId.toInt, stageId.toInt, stageAttemptNumber.toInt,
        reduceId.toInt)
    case SHUFFLE_MERGED_INDEX(appId, shuffleId, stageId, stageAttemptNumber, reduceId) =>
      ShuffleMergedIndexBlockId(appId, shuffleId.toInt, stageId.toInt, stageAttemptNumber.toInt,
        reduceId.toInt)
    case SHUFFLE_MERGED_META(appId, shuffleId, stageId, stageAttemptNumber, reduceId) =>
      ShuffleMergedMetaBlockId(appId, shuffleId.toInt, stageId.toInt, stageAttemptNumber.toInt,
        reduceId.toInt)
