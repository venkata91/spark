...
case class ShufflePushMergeBlockId(
  ...
  override def name: String = "shuffle_" + shuffleId + "_" + shuffleSequenceId + "_" +
    mapId + "_" + reduceId
}
...
object BlockId {
  ...
  val SHUFFLE_PUSH_MERGED = "shuffle_([0-9]+)_([0-9]+)_([0-9]+)_([0-9]+)".r
  ...
  def apply(name: String): BlockId = name match {
    ...
    case SHUFFLE_PUSH(shuffleId, shuffleSequenceId, mapIndex, reduceId) =>
      ShufflePushBlockId(shuffleId.toInt, shuffleSequenceId.toInt, mapIndex.toInt,
        reduceId.toInt)
    case SHUFFLE_PUSH_MERGED(shuffleId, shuffleSequenceId, mapIndex, reduceId) =>
      ShufflePushMergeBlockId(shuffleId.toInt, shuffleSequenceId.toInt, mapIndex.toInt,
        reduceId.toInt)
