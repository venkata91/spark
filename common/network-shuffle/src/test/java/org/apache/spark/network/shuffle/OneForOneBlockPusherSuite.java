...
public class OneForOneBlockPusherSuite {
  ...
  public void testPushOne() {
    ...
    verify(listener).onBlockFetchSuccess(eq("shufflePush_0_0_0_0"), any());
  }
  ...
  public void testPushThree() {
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_1_0"), any());
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_2_0"), any());
  }
  ...
  public void testServerFailures() {
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_1_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_2_0"), any());
  }
  ...
  public void testHandlingRetriableFailures() {
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0"), any());
    verify(listener, times(0)).onBlockFetchSuccess(not(eq("shufflePush_0_0_0_0")), any());
    verify(listener, times(0)).onBlockFetchFailure(eq("shufflePush_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_1_0"), any());
    verify(listener, times(2)).onBlockFetchFailure(eq("shufflePush_0_0_2_0"), any());
  }
