...
public class OneForOneBlockPusherSuite {
  ...
  public void testPushOne() {
    ...
    blocks.put("shufflePush_0_0_0_0_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[1])));
    ...
    verify(listener).onBlockFetchSuccess(eq("shufflePush_0_0_0_0_0"), any());
  }

  @Test
  public void testPushThree() {
    LinkedHashMap<String, ManagedBuffer> blocks = Maps.newLinkedHashMap();
    blocks.put("shufflePush_0_0_0_0_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[12])));
    blocks.put("shufflePush_0_0_0_1_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[23])));
    blocks.put("shufflePush_0_0_0_2_0", new NettyManagedBuffer(Unpooled.wrappedBuffer(new byte[23])));
    String[] blockIds = blocks.keySet().toArray(new String[blocks.size()]);
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_1_0"), any());
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_2_0"), any());
  }
  ...
  public void testServerFailures() {
    LinkedHashMap<String, ManagedBuffer> blocks = Maps.newLinkedHashMap();
    blocks.put("shufflePush_0_0_0_0_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[12])));
    blocks.put("shufflePush_0_0_0_1_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[0])));
    blocks.put("shufflePush_0_0_0_2_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[0])));
    String[] blockIds = blocks.keySet().toArray(new String[blocks.size()]);
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_0_1_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_0_2_0"), any());
  }
  ...
  public void testHandlingRetriableFailures() {
    LinkedHashMap<String, ManagedBuffer> blocks = Maps.newLinkedHashMap();
    blocks.put("shufflePush_0_0_0_0_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[12])));
    blocks.put("shufflePush_0_0_0_1_0", null);
    blocks.put("shufflePush_0_0_0_2_0", new NioManagedBuffer(ByteBuffer.wrap(new byte[0])));
    String[] blockIds = blocks.keySet().toArray(new String[blocks.size()]);
    ...
    verify(listener, times(1)).onBlockFetchSuccess(eq("shufflePush_0_0_0_0_0"), any());
    verify(listener, times(0)).onBlockFetchSuccess(not(eq("shufflePush_0_0_0_0_0")), any());
    verify(listener, times(0)).onBlockFetchFailure(eq("shufflePush_0_0_0_0_0"), any());
    verify(listener, times(1)).onBlockFetchFailure(eq("shufflePush_0_0_0_1_0"), any());
    verify(listener, times(2)).onBlockFetchFailure(eq("shufflePush_0_0_0_2_0"), any());
  }
